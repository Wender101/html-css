for(let c = 1; c <= 14; c++) {
    ...
    if(window.location.href != '/html-css/desafio/NerdsFirebase/pagProduto.html'') {
...
function pesquisarProduto(pesquisa = '') {
    if(location.href != '/html-css/desafio/NerdsFirebase/pagProduto.html') {
        let valPesquisa
        if(pesquisa != '') {
        ...
        for(let c = 0; c < 14; c++) {
            ...
            if(inputFeito == false) {
                ...
                if(nomeCat == pesquisaInp) {
                    ...
                    localStorage.setItem('produtoPesquisado', produtoPesquisado)
                    inputFeito = true
                    location.href = '/html-css/desafio/NerdsFirebase/pagProduto.html'
